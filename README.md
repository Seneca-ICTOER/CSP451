# Welcome to the CSP451 OER Repository

## Introduction

This is the new repo design that stores **course content** from the CDOT Wiki. This repo is also deployed to GitHub pages and can be found at this link: https://seneca-ictoer.github.io/CSP451/ .

This is the new Seneca-ICTOER open education resource that stores and hosts our amazing courses in their own webpages, giving Seneca SDDS/ITAS staff full control over all content displayed on the page. This allows Seneca to no longer need to rely on MediaWiki/ CDOT Wiki, and instead use our own **Open Education Resource** on GitHub.

Any Seneca SDDS/ITAS faculty who has the correct permissions for this repository can make changes to any of the documents included. Please **make sure** to get the **correct permissions** first before trying to edit anything in this repository. **If you don’t have correct permissions**, you won’t be able to publish your changes and will lose all data you’ve added to the repo.

**IMPORTANT**: All content for this course **MUST** be written in GitHub Markdown. A selection of helpful resources have been provided in the list below to learn markdown. **YOU MUST NOT** add any **HTML** or **CSS** code inside the .md files as it is not permitted and will result in a deployment error.
...
![Highlighted Files on GitHub](./static/img/oer-instructions/github-highlighted_files.png)

Unedited version of the file structure from above:

![Highlighted Files on GitHub - UNEDITED](./static/img/oer-instructions/github-highlighted_files-unedited.png)
...
Going to the GitHub repo page for this course: https://github.com/Seneca-ICTOER/CSP451 . 

**Follow the Steps below:**

1.	Follow the path: docs -> landing-page.md (see screenshot below of result)

![GitHub Repo](./static/img/oer-instructions/github-repo.png)
...
![Commit Changes](./static/img/oer-instructions/commit-changes.png)

5.	It should pop-up a dialog box (see screenshot below)

![Commit Dialog Box](./static/img/oer-instructions/commit-dialog.png)
...
![GitHub Codespace Web Editor](./static/img/oer-instructions/github-codespace.png)
...
![GitHub Codespace Web Editor 2](./static/img/oer-instructions/github-codespace-2.png)
...
![GitHub Codespace Source Control](./static/img/oer-instructions/github-codespace-source_control.png)
...
![VS Code Extensions](./static/img/oer-instructions/vscode-extensions.png)

3.	Enter “GitHub Actions” (see screenshot below). This should open the extension up in its own window. Click the install button.

![GitHub Actions Extension](./static/img/oer-instructions/github-actions-extension.png)
...
![GitHub Pull Request and Issues Extension](./static/img/oer-instructions/github-pr_and_issues-extension.png)

![Prettier Extension](./static/img/oer-instructions/github-prettier-extension.png)
...
![VS Code Source Control](./static/img/oer-instructions/vscode-source_control.png)

   - **IF YOU ARE INSIDE A FOLDER. CLOSE THE FOLDER AND REPEAT STEP 7**

8.	Click the “Clone Repository” button -> Click “Clone From GitHub” Popup -> Select the repo you want to clone (**Seneca-ICTOER/CSP451** in this case)
...
![VS Code File Explorer](./static/img/oer-instructions/vscode-file_explorer.png)
...
1.	Go to the home page of the repository again: https://github.com/Seneca-ICTOER/CSP451 
2.	You should see the following screen

![GitHub Check Change](./static/img/oer-instructions/github-check_change.png)
...
![GitHub Actions Tab](./static/img/oer-instructions/github-actions.png)
...
![GitHub Actions Tab Error](./static/img/oer-instructions/github-error.png)
...
![GitHub Actions Tab Error 2](./static/img/oer-instructions/github-error2.png)
...
![GitHub Actions Tab Error 3](./static/img/oer-instructions/github-error3.png)
...
![GitHub Actions Tab Pass](./static/img/oer-instructions/github-error_pass.png)
...
Now you should have completed your changes and passed all error checks! You can see your new updated course at the deployed page link: https://seneca-ictoer.github.io/CSP451/ . 
