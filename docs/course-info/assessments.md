...
At the end of the semester, you will be assessed about how you effectively used Azure Resources. Below you can find more details and information about the Budget Management:

1. Budget Management is not the best representative of this assessment criteria, a better term would be **Adherence to Cloud Resource Management** which is an important aspect of your learning in this course. You need to demonstrate that you are able to skillfully manage your cloud resources and work within your subscription constraints.
2. Budget Management is marked binary, that means you either get all the marks or lose all the marks.for mark breakdown refer to the Blackboard Portal.
3. At the end of semester, the ITAS cloud team will assess your adherence to Cloud Resource Management and communicate with the professor which students did not comply with the requirement and will automatically miss **ALL** the mark for this assessment.
4. Follow below to receive a full mark:
...
🔥 Most common mistake that causes you to lose easy mark from Azure Budget Management is a resource you do not know you have like **_disk_** or **_public-ip_** or worst of all **_bastion_** which is super costly and eats up your budget before you know. **How can you do this correctly?**
...
1. You are frequently asked to participate in class demo sessions. Volunteering in this demo session, gives you an easy bonus mark.
2. Actively enganing in class discussins, answerign questins, 
3. Regular participation in GitHub Discussion Channels to help other students resolve issues gives you an easy bonus mark.
